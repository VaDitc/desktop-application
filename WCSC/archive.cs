...
namespace WCSC
{
    public partial class archive : Form
    {
        ...
        private void GetDataForArhiveGraph(List<MeasurementData> arhiveList, int Step)
        {
            for (int i = 0; i < arhiveList.Count; i++)
            {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            List<MeasurementData> arhiveList = query_data_mes.ToList();
            ...
            else
            {
                ...
                GetDataForArhiveGraph(arhiveList, 1);
                button1.Focus();
            }
